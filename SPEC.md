...
- Banner: "Demo data — illustrative, not real findings."
...
- Demo data is labelled as demo on every screen, not only on the first.
...
8. The demo banner is visible on every screen.
